...
Note :
- Playing with the agent manually in the environment has not been implemented as it is not available with Udacity Online Worspace (No Virtual Screen)    
- Watching the trained agent playing in the environment has not been implemented either, as it is not available with Udacity Online Worspace (No Virtual Screen)
- To watch teh agent train and play in the environment run the code in your local setup
